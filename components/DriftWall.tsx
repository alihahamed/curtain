...
export interface DriftWallItem {
  /** An image, or leave it out and give a glyph to draw on a plain tile instead. */
  image?: string;
  glyph?: string;
  title?: string;
  href?: string;
    ...
    const inner = (
      <span className={innerClass}>
        {item.image ? (
          ...
          <span className="grid h-full w-full select-none place-items-center font-heading text-[calc(var(--dw-tile-h)*0.42)] leading-none text-white/80">
            {item.glyph}
          </span>
        )}
